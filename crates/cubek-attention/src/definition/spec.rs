...
impl<
    ...
    OG: Float,
    OS: Float,
> AttentionPrecision for (QG, QT, KG, KS, VG, VS, KT, VT, SM, ACC, MSK, OG, OS)
{
    type Query = (QG, QT);
    type Key = (KG, KS);
    type Value = (VG, VS);
...
// Element indices for #[define(QG, QT, KG, KS, VG, VS, KT, VT, SM, ACC, MSK, OG, OS)]
// QG=0, QT=1, KG=2, KS=3, VG=4, VS=5, KT=6, VT=7, SM=8, ACC=9, MSK=10, OG=11, OS=12
