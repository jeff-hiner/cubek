...
#[derive(CubeType)]
pub struct SoftmaxHybridFragment<E: Float, V: Float> {
...
#[cube]
impl<E: Float, V: Float> SoftmaxHybridFragment<E, V> {
    pub fn new(
        #[comptime] tile_size: TileSize,
        #[comptime] config: BlackboxAcceleratedAttentionMatmulConfig,
    ) -> Self {
...
#[cube]
impl<E: Float, V: Float> FragmentSoftmax<E> for SoftmaxHybridFragment<E, V> {
    type Layout = LocalTileLayout;
    type SoftmaxScore = cmma::Matrix<E>;
    type SoftmaxRowFormat = LocalTile<E>;
